...
<div class="col-xs-12 col-sm-12 col-form-coupon <?php echo esc_attr( $css_class ); ?>">
	...
	if ( empty( WC()->cart->applied_coupons ) ) {
		$info_message = apply_filters( 'woocommerce_checkout_coupon_message', esc_html__( 'Have a coupon?', 'martfury' ) . ' <a href="#" class="showcoupon">' . esc_html__( 'Click here to enter your code', 'martfury' ) . '</a>' );
