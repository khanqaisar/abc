		...
		<div class="pswp__scroll-wrap">
			...
			<div class="pswp__ui pswp__ui--hidden">
				...
				<div class="pswp__top-bar">
					...
					<button class="pswp__button pswp__button--close" title="<?php esc_attr_e( 'Close (Esc)', 'martfury' ) ?>"></button>

					<button class="pswp__button pswp__button--share" title="<?php esc_attr_e( 'Share', 'martfury' ) ?>"></button>

					<button class="pswp__button pswp__button--fs" title="<?php esc_attr_e( 'Toggle fullscreen', 'martfury' ) ?>"></button>

					<button class="pswp__button pswp__button--zoom" title="<?php esc_attr_e( 'Zoom in/out', 'martfury' ) ?>"></button>
				...
				<button class="pswp__button pswp__button--arrow--left" title="<?php esc_attr_e( 'Previous (arrow left)', 'martfury' ) ?>">
				</button>

				<button class="pswp__button pswp__button--arrow--right" title="<?php esc_attr_e( 'Next (arrow right)', 'martfury' ) ?>">
				</button>
